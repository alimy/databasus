  ...
  return (
    <>
      <div className="mt-4 mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
        <div className="mb-1 min-w-[180px] sm:mb-0">{label}</div>
        <Select
          value={interval?.type}
      ...
      {interval?.type === IntervalType.WEEKLY && (
        <div className="mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
          <div className="mb-1 min-w-[180px] sm:mb-0">Weekday</div>
          <Select
      ...
      {interval?.type === IntervalType.MONTHLY && (
        <div className="mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
          <div className="mb-1 min-w-[180px] sm:mb-0">Day of month</div>
          <InputNumber
            min={1}
            max={31}
      ...
      {interval?.type !== IntervalType.HOURLY && interval?.type !== IntervalType.CRON && (
        <div className="mb-1 flex w-full flex-col items-start sm:flex-row sm:items-center">
          <div className="mb-1 min-w-[180px] sm:mb-0">Time of day</div>
          <TimePicker
            value={localTime}
