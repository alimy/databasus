    ...
    return (
      <>
        <div className="mt-4 mb-1 flex w-full items-center">
          <div className="min-w-[180px]">{label}</div>
    ...
    <div>
      ...
      {backupConfig.isBackupsEnabled && (
        <>
          ...
          {backupConfig.walLagThresholdBytes > 0 && (
            <div className="mb-1 flex w-full items-center">
              <div className="min-w-[180px]">WAL lag threshold</div>
              <div>{Math.round(backupConfig.walLagThresholdBytes / (1024 * 1024))} MB</div>
            </div>
          )}
