...
func Test_Writer_Write_ProducesCombineableLayoutWithIntegrityManifest(t *testing.T) {
	...
	saveFile(t, ctx, storage, encryptor, "test-wal-0003.zst", zstdBytes(t, []byte(walBody)))
	...
	assert.Equal(t, walBody, entries["wal/000000010000000000000003"],
		"wal must be decompressed and renamed to the bare wal filename")
