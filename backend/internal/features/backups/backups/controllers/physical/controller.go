...
// @Param type query string false "Filter by backup type" Enums(FULL, INCREMENTAL, WAL)
// @Param status query string false "Filter by status (e.g. COMPLETED, IN_PROGRESS)"
