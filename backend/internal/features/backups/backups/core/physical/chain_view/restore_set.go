...
type RestoreSet struct {
	...
	// RecoveryTargetTime is nil for a "latest" restore (replay all shipped WAL)
	// or the requested PITR target, written into recovery.conf as
