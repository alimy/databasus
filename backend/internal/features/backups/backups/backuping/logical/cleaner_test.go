...
func Test_CleanExceededBackups_SkipsInProgressBackups(t *testing.T) {
	...
	completedBackups := make([]*backups_core_logical.LogicalBackup, 3)
	for i := range 3 {
		backup := &backups_core_logical.LogicalBackup{
			ID:           uuid.New(),
			DatabaseID:   database.ID,
	...
	for _, backup := range remainingBackups {
		if backup.ID == inProgressBackup.ID {
			...
			assert.Equal(t, backups_core_logical.BackupStatusInProgress, backup.Status)
		}
	}
...
func Test_GetTotalSizeByDatabase_CalculatesCorrectly(t *testing.T) {
	...
	completedBackup1 := &backups_core_logical.LogicalBackup{
		ID:           uuid.New(),
		DatabaseID:   database.ID,
		StorageID:    storage.ID,
		Status:       backups_core_logical.BackupStatusCompleted,
	...
	completedBackup2 := &backups_core_logical.LogicalBackup{
		ID:           uuid.New(),
		DatabaseID:   database.ID,
		StorageID:    storage.ID,
		Status:       backups_core_logical.BackupStatusCompleted,
	...
	failedBackup := &backups_core_logical.LogicalBackup{
		ID:           uuid.New(),
		DatabaseID:   database.ID,
		StorageID:    storage.ID,
...
func Test_CleanExceededBackups_SkipsRecentBackup_WhenOverStorageLimit(t *testing.T) {
	...
	olderRecentBackup := &backups_core_logical.LogicalBackup{
		ID:           uuid.New(),
		DatabaseID:   database.ID,
		StorageID:    storage.ID,
		Status:       backups_core_logical.BackupStatusCompleted,
	...
	newerRecentBackup := &backups_core_logical.LogicalBackup{
		ID:           uuid.New(),
		DatabaseID:   database.ID,
		StorageID:    storage.ID,
		Status:       backups_core_logical.BackupStatusCompleted,
